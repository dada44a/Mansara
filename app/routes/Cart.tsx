            ...
            <section className="max-w-7xl mx-auto px-6 sm:px-10 py-12 md:py-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        {cart.map((item) => (
                            <div key={item.id} className="group flex flex-col sm:flex-row gap-8 sm:gap-10 pb-12 border-b border-black/5 items-start">
                                <div className="w-full sm:w-40 aspect-[3/4] sm:h-56 flex-shrink-0 bg-gray-50 border border-black/10 overflow-hidden">
                                    <img src={item.image} alt={item.title} className="w-full h-full object-cover transition duration-500 " />
                                </div>
