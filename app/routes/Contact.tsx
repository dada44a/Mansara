...
export default function Contact() {
  return (
    <div className="bg-white text-black">
      ...
      {/* Hero Section */}
      <section className="h-screen flex flex-col justify-center px-6 sm:px-10">
        <h1 className="text-5xl sm:text-6xl md:text-8xl font-bold tracking-tighter leading-[0.9] mb-8">
          We Believe <br /> Stories Matter.
        </h1>

        <p className="max-w-md text-[10px] sm:text-sm md:text-base leading-relaxed opacity-80 uppercase tracking-widest text-justify">
          A sanctuary for stories, rare finds, and the curious.
        </p>
      </section>

      {/* Philosophy Section */}
      <section className="px-6 sm:px-10 py-20 md:py-32 border-t border-black/10">
      ...
      <section className="px-6 sm:px-10 py-20 md:py-32 border-t border-black/10">
        <div className="max-w-4xl">
          <h2 className="text-3xl sm:text-4xl font-semibold mb-16 tracking-tight">
            Why Read Different?
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16 text-sm uppercase tracking-widest">
      ...
      {/* Closing Statement */}
      <section className="px-6 sm:px-10 py-32 md:py-40 border-t border-black/10">
